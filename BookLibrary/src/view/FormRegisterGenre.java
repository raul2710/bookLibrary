 ...
 * @author Raul
 */
public class FormRegisterGenre extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormRegisterGenre
     */
    public FormRegisterGenre() {
        initComponents();
        this.setTitle("Cadastrar Gênero");
    ...
    public FormRegisterGenre(int id) {
        this();
        txtId.setText(String.valueOf(id));
        
        Genre genre = new GenreDAO().searchById(id);
    ...
    private void initComponents() {
        ...
        lblTitlePage.setText("Cadastro de Gênero");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (txtId.getText().isEmpty()){
            //Operação de INSERIR
            res = new GenreDAO().add(genre);
        }else{
            //Operação de ATUALIZAR
            genre.setId(Integer.parseInt(txtId.getText()));
            res = new GenreDAO().update(genre);
        }
