...
public class BookDAO {
    ...
    public int update(Book book){
        try {
            String SQL = "update " + this.tableName + " set name=?, title=?, id_genre=?, id_publisher=?"
    ...
    public List<Book> searchByStatus(String status){
        try {
            String SQL = "select book.id, book.isbn, book.title, genre.name as genre_name, publisher.name, author.name, book.status\n" +
                    "	from "+ this.tableName +" as book\n" +
                    "	inner join tb_genre as genre\n" +
