 ...
 * @author Raul
 */
public class FormRegisterAuthor extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormRegisterAuthor
     */
    public FormRegisterAuthor() {
        initComponents();
    ...
    public FormRegisterAuthor(int id) {
        this();
        txtId.setText(String.valueOf(id));
        
        Author author = new AuthorDAO().searchById(id);
    ...
    private void initComponents() {
        ...
        lblTitlePage.setText("Cadastro de Autores");
